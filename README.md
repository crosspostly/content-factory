...
**Что делает:** Автоматически проверяет код в PR с помощью Gemini 2.5 Flash
...
**Процесс:**
1. ✅ Анализирует PR против требований GitHub Issue
...
5. ✅ Автоматически фиксит проблемы в коде
6. ✅ Коммитит улучшения в ветку PR
...
1. Добавить API ключ в Settings → Secrets:
   ```

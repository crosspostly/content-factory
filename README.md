...
- [Part 2: TTS + Audio (🔄 IN PROGRESS)](#part-2-tts--audio-in-progress)
- [Part 3: Video Rendering (🔄 IN PROGRESS)](#part-3-video-rendering-in-progress)
...
- 🔄 **Озвучка** — Edge-TTS (естественная речь), Coqui XTTS (клонирование голоса) (Part 2 🔄)
- 🔄 **Видео** — MoviePy (монтаж), Pixabay API (стоки), FFmpeg (кодирование) (Part 3 🔄)
- 🔄 **Субтитры** — WhisperX (word-level timestamps), автосинхронизация (ffsubsync) (Part 3 🔄)
